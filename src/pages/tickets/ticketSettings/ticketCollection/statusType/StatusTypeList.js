...
// sections
import StatusTypeListTableRow from './StatusTypeListTableRow';
import StatusTypeListTableToolbar from './StatusTypeListTableToolbar';
import {
  ...
  ChangePage,
  setFilterBy,
} from '../../../../../redux/slices/ticket/ticketSettings/ticketStatusTypes';
...
export default function StatusTypeList() {
  const { ticketStatusTypes, filterBy, page, rowsPerPage, isLoading, initial } = useSelector((state) => state.ticketStatusTypes);
  ...
  useLayoutEffect(() => {
    dispatch(getTicketStatusTypes(page, rowsPerPage));
    return () => {
  ...
  useEffect(() => {
    if (initial) {
      setTableData(ticketStatusTypes?.data || [] );
    }
  }, [ticketStatusTypes?.data, initial]);
  ...
  const handleViewRow = (id) => navigate(PATH_SUPPORT.ticketSettings.statusTypes.view(id));
  ...
  return (
    <Container maxWidth={false} >
      <StyledCardContainer>
       <Cover name="Status Types" supportTicketSettings/>
      </StyledCardContainer>
        <TableCard>
          <StatusTypeListTableToolbar
