...
RequestTypeListTableRow.propTypes = {
  row: PropTypes.object,
  selected: PropTypes.bool,
  onViewRow: PropTypes.func,
};

export default function RequestTypeListTableRow({
  row,
  selected,
  onViewRow,
}) {

  const { name, icon, color, issueType, displayOrderNo, isActive, isDefault, createdAt } = row;
  return (
    <StyledTableRow hover selected={selected}>
      ...
      <TableCell align='left' > {issueType?.name || ''} </TableCell> 
