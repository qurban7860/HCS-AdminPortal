...
const TABLE_HEAD = [
  ...
  { id: 'status.name', label: 'Status', title: "S", align: 'left', tooltip: 'Status', allowColumn: true },
  { id: 'priority.name', label: 'Priority', title: "P", align: 'left', tooltip: 'Priority', allowColumn: true },
