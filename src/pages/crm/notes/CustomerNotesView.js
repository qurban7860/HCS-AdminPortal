...
import { deleteNote, getNotes } from '../../../redux/slices/customer/customerNote';
import CustomerNotesForm from './CustomerNotesForm';
import { handleError } from '../../../utils/errorHandler';
import ConfirmDialog from '../../../components/confirm-dialog';
import Markdown from '../../../components/markdown';

export default function CustomerNotesView({ note }) {
  ...
  return (
    <>
      <>
        {isEdit ? (
          <CustomerNotesForm noteData={note} handleEdit={handleEdit} />
        ) : (
          <>
