...
export default function UserInviteListTableRow({ row, selected, onViewRow }) {
  ...
  return (
    <StyledTableRow hover selected={selected}>
      ...
      <TableCell>
        <Chip label={row?.invitationStatus || ''} color={getStatusColor(row.invitationStatus)} size="small" />
      </TableCell>
