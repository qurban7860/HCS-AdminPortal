...
function MachineServiceRecordAddForm() {
  ...
  const handleStep = (step) => async () => {
    if (!completed[activeStep]) {
      enqueueSnackbar(`Please complete step ${activeStep+1} to continue`, { variant: 'error' });
    }else{
      setActiveStep(step);
    }
  };
            ...
            <Card sx={{ p: 3 }}>
              <Stack spacing={2}>
                <Stepper nonLinear activeStep={activeStep} connector={<ColorlibConnector  />}>
                  ...
                  <Step key='step_3' >
                    <StepLabel sx={{cursor:'pointer'}} onClick={handleStep(2)} icon='3/3'  StepIconComponent={ColorlibStepIcon}>Compl Service Record</StepLabel>
                  </Step>
                </Stepper>
                    {activeStep===0 &&
                ...
                {/* <AddFormButtons isSubmitting={isSubmitting} 
                  ...
                  saveButtonName={ activeStep === 2 ? "Publish" : "Next"} handleSave={ handleSave }
                ...
                {/* <Stepper activeStep={activeStep} nonLinear >
                  <Step key='step_1' content='ahshhhs'>
                    <StepLabel>Create Service Record</StepLabel>
                  ...
                  <Step key='step_2' >
                    <StepLabel>Check Items Value</StepLabel>
                    <StepContent>
                      <Stack spacing={2}>
                        <MachineServiceRecordsSecondStep 
                          checkItemLists={checkItemLists}
                  ...
                  <Step key='step_3' >
                    <StepLabel>Complete Service Record</StepLabel>
                    <StepContent>
                      <Stack spacing={2}>
                        <MachineServiceRecordsThirdStep 
                          serviceRecordConfig={serviceRecordConfig}
