import {  useEffect, useLayoutEffect, useCallback, useMemo, memo, useState } from 'react';
...
// slice
import { updateMachineServiceRecord, getMachineServiceRecord } from '../../../redux/slices/products/machineServiceRecord';
...
function MachineServiceRecordEditForm() {
  ...
  const toggleCancel = () => navigate(PATH_MACHINE.machines.serviceRecords.view(machineId, id));
