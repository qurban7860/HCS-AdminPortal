...
import { addNote, updateNote } from '../../../redux/slices/products/machineNote';
import { handleError } from '../../../utils/errorHandler';

export default function MachineNotesForm({ noteData, handleEdit }) {
  ...
  const onSubmit = async (data) => {
    try {
      if (noteData?._id) {
        await dispatch(updateNote(machineId, noteData?._id, data));
        await handleEdit();
