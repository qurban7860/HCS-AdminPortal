...
export default function ServiceReportTemplateEditForm() {
  ...
  const defaultValues = useMemo(
    ...
    reportType: {name: serviceReportTemplate?.reportType} || null,
    machineCategory: serviceReportTemplate?.machineCategory || null,
    machineModel: serviceReportTemplate?.machineModel || null,
    docVersionNo: serviceReportTemplate?.docVersionNo || 1,
    noOfApprovalsRequired: serviceReportTemplate?.noOfApprovalsRequired || 1,
    textBeforeCheckItems: serviceReportTemplate?.textBeforeCheckItems || '',
    checkItemCategory: null,
    // // Check Params
    ListTitle:  '',
    // paramList : serviceReportTemplate?.checkParams[0]?.paramList || [],

    textAfterCheckItems: serviceReportTemplate?.textAfterCheckItems || '',
    isOperatorSignatureRequired: serviceReportTemplate?.isOperatorSignatureRequired || false,
    enableNote: serviceReportTemplate?.enableNote || false,
    enableMaintenanceRecommendations: serviceReportTemplate?.enableMaintenanceRecommendations || false,
    enableSuggestedSpares: serviceReportTemplate?.enableSuggestedSpares || false,
    // header
    headerType: { name: serviceReportTemplate?.header?.type } || null,
    headerLeftText: serviceReportTemplate?.header?.leftText || '',
    headerCenterText: serviceReportTemplate?.header?.centerText || '',
    headerRightText: serviceReportTemplate?.header?.rightText || '',
    // footer
    footerType: { name: serviceReportTemplate?.footer?.type } || null,
    footerLeftText: serviceReportTemplate?.footer?.leftText || '',
    footerCenterText: serviceReportTemplate?.footer?.centerText || '',
    footerRightText: serviceReportTemplate?.footer?.rightText || '',

    isActive: serviceReportTemplate?.isActive
  }),
  ...
  const { reportType, ListTitle, machineModel, checkItemCategory} = watch();
