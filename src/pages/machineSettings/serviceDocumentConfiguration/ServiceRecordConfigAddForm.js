...
export default function ServiceRecordConfigAddForm() {
  ...
  const toggleCancel = () => navigate(PATH_MACHINE.machines.machineSettings.serviceRecordsConfig.root);
    ...
    <Container maxWidth={false}>
      <StyledCardContainer>
        <Cover
          ...
          url={PATH_MACHINE.machines.machineSettings.serviceRecordsConfig.root}
        />
      </StyledCardContainer>
        <Grid container>
