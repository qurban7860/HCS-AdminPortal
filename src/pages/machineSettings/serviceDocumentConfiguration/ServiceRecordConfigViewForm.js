  ...
  return (
    <Card sx={{ p: 2 }}>
      <ViewFormEditDeleteButtons 
        ...
        copyConfiguration={defaultValues.isActive && defaultValues?.status.toLowerCase() === 'approved' && (() => navigate(PATH_MACHINE.machines.machineSettings.serviceRecordsConfig.copy(serviceRecordConfig._id)))}
        ...
        backLink={() => navigate(PATH_MACHINE.machines.machineSettings.serviceRecordsConfig.root)} 
        machineSettingPage
      />
