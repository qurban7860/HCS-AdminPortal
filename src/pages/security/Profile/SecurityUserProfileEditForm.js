        ...
        <Grid item xs={12} md={12}>
          <Card sx={{ p: 3 }}>
            ...
            <Grid item md={12} display="flex">
              <RHFSwitch name="isActive" disabled label={<Typography variant="subtitle2" sx={{ mx: 0, width: 1, justifyContent: 'space-between', mb: 0.5, color: 'text.secondary' }}> Active</Typography> } />
