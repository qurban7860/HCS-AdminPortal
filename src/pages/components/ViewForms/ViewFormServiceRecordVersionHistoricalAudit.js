...
ViewFormServiceRecordVersionHistoricalAudit.propTypes = {
  value: PropTypes.object,
};
function ViewFormServiceRecordVersionHistoricalAudit({ value }) {
...
export default memo(ViewFormServiceRecordVersionHistoricalAudit)