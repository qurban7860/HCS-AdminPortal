...
export const PATH_SUPPORT = {
  ...
  settings: {
    root: path(ROOTS_SUPPORT, '/settings'),
    // ----------------------- Ticket Collection -----------------------------------------
    issueTypes: {
      root: path(ROOTS_SUPPORT, '/settings/issueTypes'),
      new: path(ROOTS_SUPPORT, '/settings/issueTypes/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/issueTypes/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/issueTypes/${id}/edit`),
    },
    requestTypes: {
      root: path(ROOTS_SUPPORT, '/settings/requestTypes'),
      new: path(ROOTS_SUPPORT, '/settings/requestTypes/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/requestTypes/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/requestTypes/${id}/edit`),
    },
    priorities: {
      root: path(ROOTS_SUPPORT, '/settings/priorities'),
      new: path(ROOTS_SUPPORT, '/settings/priorities/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/priorities/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/priorities/${id}/edit`),
    },
    statuses: {
      root: path(ROOTS_SUPPORT, '/settings/statuses'),
      new: path(ROOTS_SUPPORT, '/settings/statuses/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/statuses/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/statuses/${id}/edit`),
    },
    statusTypes: {
      root: path(ROOTS_SUPPORT, '/settings/statusTypes'),
      new: path(ROOTS_SUPPORT, '/settings/statusTypes/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/statusTypes/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/statusTypes/${id}/edit`),
    },
    impacts: {
      root: path(ROOTS_SUPPORT, '/settings/impacts'),
      new: path(ROOTS_SUPPORT, '/settings/impacts/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/impacts/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/impacts/${id}/edit`),
    },
    changeTypes: {
      root: path(ROOTS_SUPPORT, '/settings/changeTypes'),
      new: path(ROOTS_SUPPORT, '/settings/changeTypes/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/changeTypes/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/changeTypes/${id}/edit`),
    },
    changeReasons: {
      root: path(ROOTS_SUPPORT, '/settings/changeReasons'),
      new: path(ROOTS_SUPPORT, '/settings/changeReasons/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/changeReasons/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/changeReasons/${id}/edit`),
    },
    investigationReasons: {
      root: path(ROOTS_SUPPORT, '/settings/investigationReasons'),
      new: path(ROOTS_SUPPORT, '/settings/investigationReasons/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/investigationReasons/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/investigationReasons/${id}/edit`),
    },
    faults: {
      root: path(ROOTS_SUPPORT, '/settings/faults'),
      new: path(ROOTS_SUPPORT, '/settings/faults/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/faults/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/faults/${id}/edit`),
    },
    articleCategories: {
      root: path(ROOTS_SUPPORT, '/settings/articleCategories'),
      new: path(ROOTS_SUPPORT, '/settings/articleCategories/new'),
      view: (id) => path(ROOTS_SUPPORT, `/settings/articleCategories/${id}/view`),
      edit: (id) => path(ROOTS_SUPPORT, `/settings/articleCategories/${id}/edit`),
      archived: path(ROOTS_SUPPORT, '/settings/articleCategories/archived'),
      archivedView: (id) => path(ROOTS_SUPPORT, `/settings/articleCategories/archived/${id}/view`),
    },
  },
  jiraTickets: {
  ...
  //   articleCategories: {
  //     root: path(ROOTS_SUPPORT, '/ticketSettings/articleCategories'),
  //     new: path(ROOTS_SUPPORT, '/ticketSettings/articleCategories/new'),
  //     view: (id) => path(ROOTS_SUPPORT, `/ticketSettings/articleCategories/${id}/view`),
  //     edit: (id) => path(ROOTS_SUPPORT, `/ticketSettings/articleCategories/${id}/edit`),
  //     archived: path(ROOTS_SUPPORT, '/ticketSettings/articleCategories/archived'),
