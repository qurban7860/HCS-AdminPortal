...
// DASHBOARD: ASSET
// export const AssetShopPage = Loadable(
//   lazy(() => import('../pages/dashboard/AssetShopPage'))
// );
// export const AssetProductDetailsPage = Loadable(
//   lazy(() => import('../pages/dashboard/AssetProductDetailsPage'))
// );
...
// );
// export const AssetCheckoutPage = Loadable(
//   lazy(() => import('../pages/dashboard/AssetCheckoutPage'))
// );
