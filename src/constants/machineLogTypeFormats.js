export const machineLogTypeFormats = [
  {
    ...
    tableColumns: [
      ...
      { id: 'componentLength', label: 'Component Length', alwaysShow: true, defaultShow: true, searchable: true, numerical: true, convertToM: true },
      { id: 'waste', label: 'Waste', alwaysShow: true, defaultShow: true, searchable: true, numerical: true, convertToM: true },
      { id: 'coilLength', label: 'Coil Length', defaultShow: true, searchable: true, numerical: true, convertToM: true },
      { id: 'flangeHeight', label: 'Flange Height', defaultShow: true, searchable: true, numerical: true, convertToM: true },
      { id: 'webWidth', label: 'Web Width', defaultShow: true, searchable: true, numerical: true, convertToM: true },
      ...
      { id: 'coilThickness', label: 'Coil Thickness', searchable: true, numerical: true, convertToM: true },
      { id: 'coilWidth', label: 'Coil Width', searchable: true, numerical: true, convertToM: true },
      ...
      { id: 'componentType', label: 'Type', searchable: true, defaultShow: true },
    ],
