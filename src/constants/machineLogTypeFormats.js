export const machineLogTypeFormats = [
  {
    ...
    tableColumns: [
      ...
      { id: 'componentLength', label: 'Length', baseUnit: 'm', alwaysShow: true, tooltip: true, tooltipText: 'Produced Length', defaultShow: true, searchable: true, numerical: true, convertToM: true },
      { id: 'waste', label: 'Waste', baseUnit: 'm', alwaysShow: true, defaultShow: true, searchable: true, numerical: true, convertToM: true },
      { id: 'coilLength', label: 'Rem. Coil', baseUnit: 'm', defaultShow: true, tooltip: true, tooltipText: 'Remaining Coil Length', searchable: true, numerical: true, convertToM: true },
      { id: 'flangeHeight', label: 'Flange', baseUnit: 'mm', defaultShow: true, tooltip: true, tooltipText: 'Flange Height', searchable: true, numerical: true },
      { id: 'webWidth', label: 'Web', baseUnit: 'mm', defaultShow: true, tooltip: true, tooltipText: 'Web Width', searchable: true, numerical: true },
      { id: 'profileShape', label: 'P.S', defaultShow: true, tooltip: true, tooltipText: 'Profile Shape', searchable: true },
      { id: 'componentWeight', label: 'Weight', baseUnit: 'kg', searchable: true, tooltip: true, tooltipText: 'Component Weight', numerical: true },
      { id: 'coilBatchName', label: 'C.Batch', tooltip: true, tooltipText: 'Coil Batch Name', searchable: true },
      { id: 'coilThickness', label: 'C.Thickness', baseUnit: 'mm', searchable: true, tooltip: true, tooltipText: 'Coil Thickness', numerical: true },
      { id: 'coilWidth', label: 'C.Width', baseUnit: 'mm', searchable: true, tooltip: true, tooltipText: 'Coil Width', numerical: true },
      { id: 'lineSpeed', label: 'L.S', baseUnit: '%', searchable: true, tooltip: true, tooltipText: 'Line Speed' },
