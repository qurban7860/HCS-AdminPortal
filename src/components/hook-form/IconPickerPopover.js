...
import { Popover, Box, InputBase, Typography, Divider, Tabs, Tab, Stack } from '@mui/material';
...
export default function IconPickerPopover({ anchorEl, onClose, onSelect }) {
    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <InputBase
          ...
          sx={{ ml: 1, flex: 1, '& input': { fontSize: '0.875rem', py: 1 } }}
          autoFocus
        />
      </Box>
