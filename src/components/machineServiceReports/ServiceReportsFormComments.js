...
const ServiceReportsFormComments = ({ currentUser, serviceReportData, machine }) => {
...
ServiceReportsFormComments.propTypes = {
  serviceReportData: PropTypes.object.isRequired,
  currentUser: PropTypes.object.isRequired,
  machine: PropTypes.object.isRequired,
};

export default ServiceReportsFormComments;
